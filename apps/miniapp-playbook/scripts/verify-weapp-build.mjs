...
assert(Array.isArray(appJson.pages), 'app.json pages should be an array');
assert(appJson.pages.length === 1 && appJson.pages[0] === 'pages/playbook/index', 'playbook app should only expose pages/playbook/index');
assert(!('tabBar' in appJson), 'playbook app should not define tabBar');
