...
| `characters/` | 角色立绘/头像 | `src/pages/home/index.model.ts` | 900×900 JPG，`LOCAL_CHARACTER_AVATARS` 按角色名映射 |
| `home/` | 首页脚本封面 | `src/pages/home/index.model.ts`、`src/pages/chat/list.tsx` | `LOCAL_SCRIPT_COVERS` 按 slug 映射 |
