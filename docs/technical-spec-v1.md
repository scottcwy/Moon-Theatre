...
本文档为 V1 正式版 SPEC。第一版范围以 `docs/prd-v1.md` 和本文档为准；界面结构、底部导航和视觉细节参考 `DESIGN.md` 以及用户确认的 Figma 设计稿：

<https://www.figma.com/design/ACLI3DRcjPUZ1RzKOIFoCS/%E8%A7%92%E8%89%B2%E6%89%AE%E6%BC%94%E5%B0%8F%E7%A8%8B%E5%BA%8F%E8%AE%BE%E8%AE%A1?t=Sn2XRppnDNQoPotV-0>
...
3. 界面细节以 Figma 设计稿和 `DESIGN.md` 为准。
