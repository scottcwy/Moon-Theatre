...
func (s *Server) handleCORS(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Access-Control-Allow-Headers", "Authorization, Content-Type, x-fastclaw-agent-id, x-fastclaw-session-key, x-fastclaw-user-id, x-fastclaw-scope, x-fastclaw-message-id, x-fastclaw-no-persist")
